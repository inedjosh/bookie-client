...
const PostABookModal: FC<ModalComponentProps> = ({ modalId }) => {
  ...
  return (
    <Dialog
      ...
      onClose={() => hideModal(MODAL_ID.ADD_BOOK)}
    >
          ...
          >
            <div className="flex p-5 justify-between">
              ...
              <div
                ...
                onClick={() => hideModal(MODAL_ID.ADD_BOOK)}
              >
