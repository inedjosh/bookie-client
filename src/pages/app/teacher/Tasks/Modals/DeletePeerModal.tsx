...
function DeletePeerModal({ modalId }: ModalComponentProps) {
      ...
      <div className="w-full h-[220px] px-5 md:px-10 overflow-visible md:w-[500px]">
        <div>
          <Typography variant="subheading" as="h2" className="my-5">
            Are you sure you want to delete this peer assignment?
          </Typography>
...
export default DeletePeerModal;
