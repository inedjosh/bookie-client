...
function CreateNewVideoModal({ modalId }: ModalComponentProps) {
  ...
  const submit = async () => {
    try {
      await postData(`video/`, { ...values, course: cohort?.course._id });
    } finally {
      resetForm();
  ...
  return (
    <Modal modalId={modalId}>
      <ModalHeader modalId={modalId}>
        <Typography variant="subheading">Create Video </Typography>
      </ModalHeader>
