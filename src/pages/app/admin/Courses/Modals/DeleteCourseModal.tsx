...
function DeleteCourseDetailsModal({ modalId }: ModalComponentProps) {
  ...
  return (
    <Modal modalId={modalId}>
      <div className="w-full h-[100px] overflow-visible md:w-[500px]">
...
export default DeleteCourseDetailsModal;
