...
function AssignmentModal({ modalId }: ModalComponentProps) {
                  ...
                  <div className=" px-5 md:px-10">
                    ...
                    <div className="bg-[#FDF1D8] rounded-[32px] px-10 py-5">
                      ...
                      <Typography as="p" className="py-3 text-[#212121]">
                        ...
                        <br />
                        <br />
                        After completing your assignment, ensure your work is
                        properly documented. Export your final output as to the
                        required submission file type e.g (PDF, CSV) and upload
                        it on the submission panel.
                      </Typography>
                      <Typography as="p" className="py-3 text-[#212121]">
                        <strong className="text-black">&#x2022; Score:</strong>
                        <br /> <br />
                        Your work will be graded by the teacher based on a
                        pre-determined grading rubric. Please ensure your
                        submission meets all the criteria outlined in the
                        description to maximize your points. Grading may take
                        between 30 minutes to 2 hours, so please be patient as
