...
import { Calendar, Cap, ColorStar, ColorTime } from "../../../../../assets";
import Loader from "../../../../../components/Loader";

type Props = {
  _id: string;
  type: "class" | "mini-class";
      ...
      if (status === ClassTypeList.COMPLETED) {
        if (!recordedUrl) {
          ...
          const response = await updateData<any>(
            `class/${user?._id}/student/${_id}/attendance?joined=late`,
            {},
            false
          );
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const response = await updateData<any>(
          `class/${user?._id}/student/${_id}/attendance?joined=early`,
          {}
        );
    ...
    <>
      {alignment === "vertical" ? (
              ...
              <div>
                ...
                <div className="flex mt-2 items-center">
                  ...
                  <div className="flex items-center ml-4">
                    <img src={ColorTime} className="w-5" />
                    ...
                    <Typography
                      ...
                      className="pl-1"
                    >
                      {readableDateTime(new Date(date)).time}
                    </Typography>
                  </div>
                  <div className="flex items-center ml-4">
        ...
        >
          ...
          <div onClick={() => {}} className="flex-[.15] flex items-center">
            {loading ? (
              <Loader />
            ) : (
              <Typography
